...
const quotes = [
  ...
  'Кармин', 'Алый', 'Амарантовый', 'Аметистовый', 'Арлекин', '	Баклажановый', 'Бирюзовый', '	Бистр', 'Бургундский', 'Бурый',
  'Васильковый', 'Горчичный', 'Изумруд', 'Кирпичный', 'Коралловый', 'Малиновый', 'Медный', 'Мятный', 'Охра', 'Серебряный'];
